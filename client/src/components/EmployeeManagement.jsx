...
import { API_BASE_URL, EMPLOYEE_ROLES, formatDate } from '../utils/constants';
...
const EmployeeManagement = ({ authState }) => {
    ...
    }, [authState.token, searchQuery, filterDept]);
    ...
    }, [authState.token, fetchDropdownData, fetchEmployees]); // Re-fetch when search or filter changes
